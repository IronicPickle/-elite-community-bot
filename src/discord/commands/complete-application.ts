...
export default class CompleteApplication extends Command {
  constructor(client: Client) {
    super(client, {
      name: "complete-application",
      aliases: [],
      group: "management",
      memberName: "complete-application",
      description: "Completes a member's application.",
      userPermissions: [ config.permissions["complete-application"] ],
      guildOnly: true,
  ...
  run(commandoMessage: CommandoMessage) {
    ...
    new Promise(async () => {
      ...
      inputListener.start("@ the member whose application you would like to complete.", async (listenerMessage?: Message) => {
